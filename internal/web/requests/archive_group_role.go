...
//
// The archive wire pair for one group_roles entry.
//
// entity:     Group
// spec:       specs/omnicore-gen/group.omnicore.yaml
// generator:  omnicore-gen
// generated:  2026-09-01
// checksum:   sha256:5d152eecf21b81c58ebfbab1567eb88d14f9ff2d3f55225a4b7e1ede17ad1ba5
//
...
func (r ArchiveGroupRoleRequest) ToCommand() *commands.ArchiveGroupRoleCommand {
	return fwrequests.AutoFromRequest[*commands.ArchiveGroupRoleCommand](r)
}

// ArchiveGroupRoleGraphQLRequest names the entry to take out.
//
...
type ArchiveGroupRoleGraphQLRequest struct {
	fwrequests.Auto
...
// field, and the pair is checked at boot. A shape that needed renaming or
// reshaping would drop the marker and write ToCommand by hand instead.
func (r ArchiveGroupRoleGraphQLRequest) ToCommand() *commands.ArchiveGroupRoleCommand {
	return fwrequests.AutoFromRequest[*commands.ArchiveGroupRoleCommand](r)
}

// ArchiveGroupRoleGraphQLResponse acknowledges the removal, and says nothing
// else.
//
...
type ArchiveGroupRoleGraphQLResponse struct {
	Success bool `json:"success"`
}

// FromResult answers true: the pipeline only projects a result it succeeded
// with.
func (ArchiveGroupRoleGraphQLResponse) FromResult(fwresults.None) ArchiveGroupRoleGraphQLResponse {
	return ArchiveGroupRoleGraphQLResponse{Success: true}
}
