...
//
// The wire mapper tests for archive_client_role.go.
//
// entity:     Client
// spec:       specs/omnicore-gen/client.omnicore.yaml
// generator:  omnicore-gen
// generated:  2026-09-01
// checksum:   sha256:1ac379dfa737325bf5b73ae749cfc2e50014b5c8c72108dc123ac5381d4781f8
//
...
// ArchiveClientRoleRequest carries the addressed entry into its command.
func TestArchiveClientRoleRequest_NamesTheEntry(t *testing.T) {
	r := ArchiveClientRoleRequest{ClientRoleID: "01890000-0000-7000-8000-000000000000"}
...
// ArchiveClientRoleGraphQLRequest names the entry through its input.
func TestArchiveClientRoleGraphQLRequest_NamesTheEntry(t *testing.T) {
	r := ArchiveClientRoleGraphQLRequest{ClientRoleID: "01890000-0000-7000-8000-000000000000"}
	if r.ToCommand().ClientRoleID != "01890000-0000-7000-8000-000000000000" {
		t.Error("the entry id did not reach the command, so the wrong entry would be removed")
	}
}

// ArchiveClientRoleGraphQLResponse acknowledges, since a mutation must answer
// something.
//
...
func TestArchiveClientRoleGraphQLResponse_Acknowledges(t *testing.T) {
	if !(ArchiveClientRoleGraphQLResponse{}).FromResult(fwresults.None{}).Success {
