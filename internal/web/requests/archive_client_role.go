...
//
// The archive wire pair for one client_roles entry.
//
// entity:     Client
// spec:       specs/omnicore-gen/client.omnicore.yaml
// generator:  omnicore-gen
// generated:  2026-09-01
// checksum:   sha256:617d453e414939c54c34f13ce0217e924ffd16205d98d1aa5fb7d87d1838af10
//
...
func (r ArchiveClientRoleRequest) ToCommand() *commands.ArchiveClientRoleCommand {
	return fwrequests.AutoFromRequest[*commands.ArchiveClientRoleCommand](r)
}

// ArchiveClientRoleGraphQLRequest names the entry to take out.
//
...
type ArchiveClientRoleGraphQLRequest struct {
	fwrequests.Auto
...
// field, and the pair is checked at boot. A shape that needed renaming or
// reshaping would drop the marker and write ToCommand by hand instead.
func (r ArchiveClientRoleGraphQLRequest) ToCommand() *commands.ArchiveClientRoleCommand {
	return fwrequests.AutoFromRequest[*commands.ArchiveClientRoleCommand](r)
}

// ArchiveClientRoleGraphQLResponse acknowledges the removal, and says nothing
// else.
//
...
type ArchiveClientRoleGraphQLResponse struct {
	Success bool `json:"success"`
}

// FromResult answers true: the pipeline only projects a result it succeeded
// with.
func (ArchiveClientRoleGraphQLResponse) FromResult(fwresults.None) ArchiveClientRoleGraphQLResponse {
	return ArchiveClientRoleGraphQLResponse{Success: true}
}
