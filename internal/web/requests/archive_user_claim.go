...
//
// The archive wire pair for one user_claims entry.
//
// entity:     User
// spec:       specs/omnicore-gen/user.omnicore.yaml
// generator:  omnicore-gen
// generated:  2026-09-01
// checksum:   sha256:f4fcf0fb72684daaad1ec7669ff2a3be973050fed378d50fa60305878dd42386
//
...
func (r ArchiveUserClaimRequest) ToCommand() *commands.ArchiveUserClaimCommand {
	return fwrequests.AutoFromRequest[*commands.ArchiveUserClaimCommand](r)
}

// ArchiveUserClaimGraphQLRequest names the entry to take out.
//
...
type ArchiveUserClaimGraphQLRequest struct {
	fwrequests.Auto
...
// field, and the pair is checked at boot. A shape that needed renaming or
// reshaping would drop the marker and write ToCommand by hand instead.
func (r ArchiveUserClaimGraphQLRequest) ToCommand() *commands.ArchiveUserClaimCommand {
	return fwrequests.AutoFromRequest[*commands.ArchiveUserClaimCommand](r)
}

// ArchiveUserClaimGraphQLResponse acknowledges the removal, and says nothing
// else.
//
...
type ArchiveUserClaimGraphQLResponse struct {
	Success bool `json:"success"`
}

// FromResult answers true: the pipeline only projects a result it succeeded
// with.
func (ArchiveUserClaimGraphQLResponse) FromResult(fwresults.None) ArchiveUserClaimGraphQLResponse {
	return ArchiveUserClaimGraphQLResponse{Success: true}
}
