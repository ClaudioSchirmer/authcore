...
//
// The archive wire pair for one client_allowed_cidrs entry.
//
// entity:     Client
// spec:       specs/omnicore-gen/client.omnicore.yaml
// generator:  omnicore-gen
// generated:  2026-09-01
// checksum:   sha256:e6f58c9b96a264e533d59244b2300cc83a461615ea45c3a1cfdc1fc7763f6028
//
...
func (r ArchiveClientAllowedCIDRRequest) ToCommand() *commands.ArchiveClientAllowedCIDRCommand {
	return fwrequests.AutoFromRequest[*commands.ArchiveClientAllowedCIDRCommand](r)
}

// ArchiveClientAllowedCIDRGraphQLRequest names the entry to take out.
//
...
type ArchiveClientAllowedCIDRGraphQLRequest struct {
	fwrequests.Auto
...
// field, and the pair is checked at boot. A shape that needed renaming or
// reshaping would drop the marker and write ToCommand by hand instead.
func (r ArchiveClientAllowedCIDRGraphQLRequest) ToCommand() *commands.ArchiveClientAllowedCIDRCommand {
	return fwrequests.AutoFromRequest[*commands.ArchiveClientAllowedCIDRCommand](r)
}

// ArchiveClientAllowedCIDRGraphQLResponse acknowledges the removal, and says
// nothing else.
//
...
type ArchiveClientAllowedCIDRGraphQLResponse struct {
	Success bool `json:"success"`
}

// FromResult answers true: the pipeline only projects a result it succeeded
// with.
func (ArchiveClientAllowedCIDRGraphQLResponse) FromResult(fwresults.None) ArchiveClientAllowedCIDRGraphQLResponse {
	return ArchiveClientAllowedCIDRGraphQLResponse{Success: true}
}
