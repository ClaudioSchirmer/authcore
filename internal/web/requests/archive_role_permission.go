...
//
// The archive wire pair for one role_permissions entry.
//
// entity:     Role
// spec:       specs/omnicore-gen/role.omnicore.yaml
// generator:  omnicore-gen
// generated:  2026-09-01
// checksum:   sha256:f1dae3e3d09498a91f45b586e7c5807fb561f1d7af333156f48f9071214244e1
//
...
func (r ArchiveRolePermissionRequest) ToCommand() *commands.ArchiveRolePermissionCommand {
	return fwrequests.AutoFromRequest[*commands.ArchiveRolePermissionCommand](r)
}

// ArchiveRolePermissionGraphQLRequest names the entry to take out.
//
...
type ArchiveRolePermissionGraphQLRequest struct {
	fwrequests.Auto
...
// field, and the pair is checked at boot. A shape that needed renaming or
// reshaping would drop the marker and write ToCommand by hand instead.
func (r ArchiveRolePermissionGraphQLRequest) ToCommand() *commands.ArchiveRolePermissionCommand {
	return fwrequests.AutoFromRequest[*commands.ArchiveRolePermissionCommand](r)
}

// ArchiveRolePermissionGraphQLResponse acknowledges the removal, and says
// nothing else.
//
...
type ArchiveRolePermissionGraphQLResponse struct {
	Success bool `json:"success"`
}

// FromResult answers true: the pipeline only projects a result it succeeded
// with.
func (ArchiveRolePermissionGraphQLResponse) FromResult(fwresults.None) ArchiveRolePermissionGraphQLResponse {
	return ArchiveRolePermissionGraphQLResponse{Success: true}
}
