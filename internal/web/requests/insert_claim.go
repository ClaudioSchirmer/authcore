...
// checksum:   sha256:712b79f333950e051803134e43a5600feaf3d3e4ef1688dc8381d8b4d306dd4e
//
...
// InsertClaimRequest is the body of Create a claim.
...
func (r InsertClaimRequest) ToCommand() *commands.InsertClaimCommand {
	return fwrequests.AutoFromRequest[*commands.InsertClaimCommand](r)
}

// InsertClaimResponse is what Create a claim returns.
type InsertClaimResponse struct {
	fwresponses.Auto
...
// FromResult projects the application Result onto InsertClaimResponse.
//
...
func (InsertClaimResponse) FromResult(r commands.InsertClaimResult) InsertClaimResponse {
	return fwresponses.AutoFromResult[InsertClaimResponse](r)
}
