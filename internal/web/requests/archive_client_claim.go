...
//
// The archive wire pair for one client_claims entry.
//
// entity:     Client
// spec:       specs/omnicore-gen/client.omnicore.yaml
// generator:  omnicore-gen
// generated:  2026-09-01
// checksum:   sha256:c7d02c3e87ff9d8b39aaca0ba71b796b647445ab725d10513ec739884359f869
//
...
func (r ArchiveClientClaimRequest) ToCommand() *commands.ArchiveClientClaimCommand {
	return fwrequests.AutoFromRequest[*commands.ArchiveClientClaimCommand](r)
}

// ArchiveClientClaimGraphQLRequest names the entry to take out.
//
...
type ArchiveClientClaimGraphQLRequest struct {
	fwrequests.Auto
...
// field, and the pair is checked at boot. A shape that needed renaming or
// reshaping would drop the marker and write ToCommand by hand instead.
func (r ArchiveClientClaimGraphQLRequest) ToCommand() *commands.ArchiveClientClaimCommand {
	return fwrequests.AutoFromRequest[*commands.ArchiveClientClaimCommand](r)
}

// ArchiveClientClaimGraphQLResponse acknowledges the removal, and says nothing
// else.
//
...
type ArchiveClientClaimGraphQLResponse struct {
	Success bool `json:"success"`
}

// FromResult answers true: the pipeline only projects a result it succeeded
// with.
func (ArchiveClientClaimGraphQLResponse) FromResult(fwresults.None) ArchiveClientClaimGraphQLResponse {
	return ArchiveClientClaimGraphQLResponse{Success: true}
}
