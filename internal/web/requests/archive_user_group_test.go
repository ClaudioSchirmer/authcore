...
//
// The wire mapper tests for archive_user_group.go.
//
// entity:     User
// spec:       specs/omnicore-gen/user.omnicore.yaml
// generator:  omnicore-gen
// generated:  2026-09-01
// checksum:   sha256:8daee065a3705cfc31b5d3c6cbb39ce26e0dff727a6cfd8c38232f96436a07ff
//
...
// ArchiveUserGroupRequest carries the addressed entry into its command.
func TestArchiveUserGroupRequest_NamesTheEntry(t *testing.T) {
	r := ArchiveUserGroupRequest{UserGroupID: "01890000-0000-7000-8000-000000000000"}
...
// ArchiveUserGroupGraphQLRequest names the entry through its input.
func TestArchiveUserGroupGraphQLRequest_NamesTheEntry(t *testing.T) {
	r := ArchiveUserGroupGraphQLRequest{UserGroupID: "01890000-0000-7000-8000-000000000000"}
	if r.ToCommand().UserGroupID != "01890000-0000-7000-8000-000000000000" {
		t.Error("the entry id did not reach the command, so the wrong entry would be removed")
	}
}

// ArchiveUserGroupGraphQLResponse acknowledges, since a mutation must answer
// something.
//
...
func TestArchiveUserGroupGraphQLResponse_Acknowledges(t *testing.T) {
	if !(ArchiveUserGroupGraphQLResponse{}).FromResult(fwresults.None{}).Success {
