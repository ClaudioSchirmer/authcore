...
type PatchUserRequest struct {
	...
	GivenName  *string `json:"givenName,omitempty" example:"Maria"`
	FamilyName *string `json:"familyName,omitempty" example:"Souza Lima"`
...
// PatchUserResponse is what Update an user (partial) returns.
