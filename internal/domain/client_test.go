...
// checksum:   sha256:9bbf535bff7750af1e90f2772f55e3d0cd78e4c04fa7f6d73e76361b09369b88
//
...
// them have it anyway.
func TestClient_InsertOutsideTenantID_IsRefused(t *testing.T) {
	e := validClient()
...
// would never have shown it to them, and without this the write side would let
// them have it anyway.
func TestClient_UpdateOutsideTenantID_IsRefused(t *testing.T) {
	e := validClient()
	e.RequestingTenant = "somebody-else"
...
func TestClient_ArchiveOutsideTenantID_IsRefused(t *testing.T) {
	e := validClient()
	e.RequestingTenant = "somebody-else"
...
func TestClient_IdentityWithoutTenantID_IsRefused(t *testing.T) {
	e := validClient()
	e.RequestingTenant = ""
	if _, err := domain.GetInsertable(e, &stubClientService{}, "GetInsertable"); err == nil {
