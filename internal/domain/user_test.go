...
// checksum:   sha256:bcdec5e44c5288e5ddc1f3d410617678012705137952869796f97b69bd897f06
//
...
// them have it anyway.
func TestUser_InsertOutsideTenant_IsRefused(t *testing.T) {
	e := validUser()
...
// would never have shown it to them, and without this the write side would let
// them have it anyway.
func TestUser_UpdateOutsideTenant_IsRefused(t *testing.T) {
	e := validUser()
	e.RequestingTenant = "somebody-else"
...
func TestUser_ArchiveOutsideTenant_IsRefused(t *testing.T) {
	e := validUser()
	e.RequestingTenant = "somebody-else"
...
func TestUser_IdentityWithoutTheClaim_IsRefused(t *testing.T) {
	e := validUser()
	e.RequestingTenant = ""
	if _, err := domain.GetInsertable(e, &stubUserService{}, "GetInsertable"); err == nil {
