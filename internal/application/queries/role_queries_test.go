...
// checksum:   sha256:d0f2cbe745ca9a5a6cb6597e7ebb6331ea537a9ccaa2c393519159a53fc0e9b8
//
...
func TestRoleCriteriaBuild(t *testing.T) {
	...
	if _, err := (FindRoleByIDQuery{}).ToCriteria(ctx); err != nil {
...
func TestRoleReadsSurviveAnEmptyResult(t *testing.T) {
	ctx := &configuration.AppContext{}
	if _, err := (FindRoleByIDQuery{}).FromQueryResult(ctx, FindRoleByIDResult{}); err != nil {
...
func TestRoleDerivationsRun(t *testing.T) {
	ctx := &configuration.AppContext{}
	{
		...
		r := FindRoleByIDResult{Permissions: []RolePermissionRowResult{{Resource: &rolePermissionResource, Action: &rolePermissionAction}}}
	...
	}
	{
		rolePermissionResource := string("tenant")
		rolePermissionAction := string("read")
		r := FindRolesByParamsResult{Permissions: []RolePermissionRowResult{{Resource: &rolePermissionResource, Action: &rolePermissionAction}}}
