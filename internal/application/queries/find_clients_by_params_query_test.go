...
//
// The read tests for find_clients_by_params_query.go.
//
// entity:     Client
...
// FindClientsByParamsQuery's criteria mapper must not fail on a well-formed
// query.
//
...
func TestFindClientsByParamsQueryCriteriaBuilds(t *testing.T) {
...
// FindClientsByParamsQuery's derivation seat must survive a Result with
// nothing in it.
//
...
func TestFindClientsByParamsQuerySurvivesAnEmptyResult(t *testing.T) {
	ctx := &configuration.AppContext{}
