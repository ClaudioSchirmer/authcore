...
//
// The read tests for find_claims_by_params_query.go.
//
// entity:     Claim
...
// FindClaimsByParamsQuery's criteria mapper must not fail on a well-formed
// query.
//
...
func TestFindClaimsByParamsQueryCriteriaBuilds(t *testing.T) {
...
// FindClaimsByParamsQuery's derivation seat must survive a Result with nothing
// in it.
//
...
func TestFindClaimsByParamsQuerySurvivesAnEmptyResult(t *testing.T) {
	ctx := &configuration.AppContext{}
