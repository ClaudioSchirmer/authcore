...
// checksum:   sha256:55abddf18ada2eb670ee29d9f06a36a81d1333f89e6955df1aa12c6b7404ee3a
//
...
func TestUserCriteriaBuild(t *testing.T) {
	...
	if _, err := (FindUserByIDQuery{}).ToCriteria(ctx); err != nil {
...
func TestUserReadsSurviveAnEmptyResult(t *testing.T) {
	ctx := &configuration.AppContext{}
	if _, err := (FindUserByIDQuery{}).FromQueryResult(ctx, FindUserByIDResult{}); err != nil {
