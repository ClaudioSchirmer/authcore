...
// checksum:   sha256:09a0fb0967e126d2781ec5b55a00dae240802a55fa7236c6e6ee1cd1f578c39b
//
...
// FindClaimByIDQuery is the application-side transport for the by-id read.
//
...
type FindClaimByIDQuery struct {
...
func (q FindClaimByIDQuery) ToCriteria(ctx *configuration.AppContext) (fwqueries.ReadCriteria, error) {
	crit := q.Criteria
...
func (q FindClaimByIDQuery) FromQueryResult(_ *configuration.AppContext, r FindClaimByIDResult) (FindClaimByIDResult, error) {
	return r, nil
}

// ContextName labels this aggregate in the error envelope.
func (q FindClaimByIDQuery) ContextName() string { return "Claim" }

// FindClaimByIDResult is what the by-id read returns.
//
