...
//
// The archive command for one client_allowed_cidrs entry.
//
// entity:     Client
// spec:       specs/omnicore-gen/client.omnicore.yaml
// generator:  omnicore-gen
// generated:  2026-09-01
// checksum:   sha256:3f01047e40c53dcc4f8445483bb20502f78ee6565a1215f4300454c030786c38
//
...
// ArchiveClientAllowedCIDRCommand takes ONE entry out of the collection.
//
...
// or purged.
type ArchiveClientAllowedCIDRCommand struct {
	pipeline.CommandWithBodyIDBase
	ClientAllowedCIDRID string
}

func (cmd *ArchiveClientAllowedCIDRCommand) ApplyTo(ctx *configuration.AppContext, e *appdomain.Client) error {
...
// FromEntity projects nothing: the entry ArchiveClientAllowedCIDRCommand named
// is
// gone, so the endpoint answers 204 — and the framework's NoBody projection
// is paired with a None on this side.
func (cmd *ArchiveClientAllowedCIDRCommand) FromEntity(_ *configuration.AppContext, _ *appdomain.Client) (fwresults.None, error) {
