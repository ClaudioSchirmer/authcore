...
//
// Tests for archive_client_allowed_cidr_command.go.
//
// entity:     Client
...
// ArchiveClientAllowedCIDRCommand takes the named entry out of the collection.
//
...
func TestArchiveClientAllowedCIDRCommand_TakesTheEntryOut(t *testing.T) {
	...
	cmd := &ArchiveClientAllowedCIDRCommand{ClientAllowedCIDRID: "019ffd00-0000-7000-8000-0000000000a1"}
