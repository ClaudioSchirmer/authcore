...
//
// The add command for one client_roles entry.
//
// entity:     Client
// spec:       specs/omnicore-gen/client.omnicore.yaml
// generator:  omnicore-gen
// generated:  2026-09-07
// checksum:   sha256:d691634a2811c882ef308ed9a4df89e734ec470e325e480d935bc432bce9b854
//
...
type AddClientRoleResult struct {
	ClientID   domain.ID
	ClientRole cmddtos.ClientRoleResult
}
...
func (cmd *AddClientRoleCommand) FromEntity(_ *configuration.AppContext, e *appdomain.Client) (AddClientRoleResult, error) {
	...
	if len(items) > 0 {
		out.ClientRole = cmdutils.ProjectOneClientRole(items[len(items)-1])
	}
	return out, nil
}
