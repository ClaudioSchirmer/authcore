...
//
// Tests for archive_group_role_command.go.
//
// entity:     Group
...
// ArchiveGroupRoleCommand takes the named entry out of the collection.
//
...
func TestArchiveGroupRoleCommand_TakesTheEntryOut(t *testing.T) {
	...
	cmd := &ArchiveGroupRoleCommand{GroupRoleID: "019ffd00-0000-7000-8000-0000000000a1"}
