...
//
// The archive command for one user_groups entry.
//
// entity:     User
// spec:       specs/omnicore-gen/user.omnicore.yaml
// generator:  omnicore-gen
// generated:  2026-09-01
// checksum:   sha256:39dd000ca40fe6fb0902ba074518d51a80f21fd762bc2aa73d7453cf7f8dba3f
//
...
// ArchiveUserGroupCommand takes ONE entry out of the collection.
//
...
// or purged.
type ArchiveUserGroupCommand struct {
	pipeline.CommandWithBodyIDBase
	UserGroupID string
}

func (cmd *ArchiveUserGroupCommand) ApplyTo(ctx *configuration.AppContext, e *appdomain.User) error {
...
// FromEntity projects nothing: the entry ArchiveUserGroupCommand named is
// gone, so the endpoint answers 204 — and the framework's NoBody projection
// is paired with a None on this side.
func (cmd *ArchiveUserGroupCommand) FromEntity(_ *configuration.AppContext, _ *appdomain.User) (fwresults.None, error) {
