...
//
// Tests for archive_user_claim_command.go.
//
// entity:     User
...
// ArchiveUserClaimCommand takes the named entry out of the collection.
//
...
func TestArchiveUserClaimCommand_TakesTheEntryOut(t *testing.T) {
	...
	cmd := &ArchiveUserClaimCommand{UserClaimID: "019ffd00-0000-7000-8000-0000000000a1"}
