...
//
// The archive command for one user_roles entry.
//
// entity:     User
// spec:       specs/omnicore-gen/user.omnicore.yaml
// generator:  omnicore-gen
// generated:  2026-09-07
// checksum:   sha256:3fbf026cf35abbe744f560a877fa0527789a92be4897c38c39ab6d9e260f8645
//
...
// ArchiveUserRoleCommand takes ONE entry out of the collection.
//
...
// or purged.
type ArchiveUserRoleCommand struct {
	pipeline.CommandWithBodyIDBase
	UserRoleID string
}

func (cmd *ArchiveUserRoleCommand) ApplyTo(ctx *configuration.AppContext, e *appdomain.User) error {
...
// FromEntity projects nothing: the entry ArchiveUserRoleCommand named is
// gone, so the endpoint answers 204 — and the framework's NoBody projection
// is paired with a None on this side.
func (cmd *ArchiveUserRoleCommand) FromEntity(_ *configuration.AppContext, _ *appdomain.User) (fwresults.None, error) {
