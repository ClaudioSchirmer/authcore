...
//
// The archive command for one role_permissions entry.
//
// entity:     Role
// spec:       specs/omnicore-gen/role.omnicore.yaml
// generator:  omnicore-gen
// generated:  2026-09-01
// checksum:   sha256:88a2751b645a2a6933137a8d110ac986dece3bee483cecc3f8cd921bd53b356a
//
...
// ArchiveRolePermissionCommand takes ONE entry out of the collection.
//
...
// or purged.
type ArchiveRolePermissionCommand struct {
	pipeline.CommandWithBodyIDBase
	RolePermissionID string
}

func (cmd *ArchiveRolePermissionCommand) ApplyTo(ctx *configuration.AppContext, e *appdomain.Role) error {
...
// FromEntity projects nothing: the entry ArchiveRolePermissionCommand named is
// gone, so the endpoint answers 204 — and the framework's NoBody projection
// is paired with a None on this side.
func (cmd *ArchiveRolePermissionCommand) FromEntity(_ *configuration.AppContext, _ *appdomain.Role) (fwresults.None, error) {
