...
//
// The archive command for one group_roles entry.
//
// entity:     Group
// spec:       specs/omnicore-gen/group.omnicore.yaml
// generator:  omnicore-gen
// generated:  2026-09-01
// checksum:   sha256:cdb4ad5857c04855499605db666cd0ff095b0556daf65034a76e387c0ca0bdb5
//
...
// ArchiveGroupRoleCommand takes ONE entry out of the collection.
//
...
// or purged.
type ArchiveGroupRoleCommand struct {
	pipeline.CommandWithBodyIDBase
	GroupRoleID string
}

func (cmd *ArchiveGroupRoleCommand) ApplyTo(ctx *configuration.AppContext, e *appdomain.Group) error {
...
// FromEntity projects nothing: the entry ArchiveGroupRoleCommand named is
// gone, so the endpoint answers 204 — and the framework's NoBody projection
// is paired with a None on this side.
func (cmd *ArchiveGroupRoleCommand) FromEntity(_ *configuration.AppContext, _ *appdomain.Group) (fwresults.None, error) {
