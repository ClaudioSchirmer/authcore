...
//
// The archive command for one client_claims entry.
//
// entity:     Client
// spec:       specs/omnicore-gen/client.omnicore.yaml
// generator:  omnicore-gen
// generated:  2026-09-07
// checksum:   sha256:d31b55cfe980cc1e285f925841244cba4791e74755fcac0883097b6851f89eb4
//
...
// ArchiveClientClaimCommand takes ONE entry out of the collection.
//
...
// or purged.
type ArchiveClientClaimCommand struct {
	pipeline.CommandWithBodyIDBase
	ClientClaimID string
}

func (cmd *ArchiveClientClaimCommand) ApplyTo(ctx *configuration.AppContext, e *appdomain.Client) error {
...
// FromEntity projects nothing: the entry ArchiveClientClaimCommand named is
// gone, so the endpoint answers 204 — and the framework's NoBody projection
// is paired with a None on this side.
func (cmd *ArchiveClientClaimCommand) FromEntity(_ *configuration.AppContext, _ *appdomain.Client) (fwresults.None, error) {
