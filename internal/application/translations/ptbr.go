...
func (ptbr) Translations() map[string]string {
	return map[string]string{
		...
		"RoleKeyAlreadyExistsNotification":           "Este tenant já possui um papel com esta chave.",
		"RoleKeyIsImmutableNotification":             "A chave do papel não pode ser alterada.",
		"RoleTenantIsImmutableNotification":          "O tenant do papel não pode ser alterado.",
		"RoleTenantDoesNotExistNotification":         "O tenant não existe ou não está mais ativo.",
		...
		"CannotGrantWildcardPermissionNotification":  "Uma permissão curinga não pode ser concedida em um papel.",
		"InvalidRoleKeyNotification":                 "A chave do papel deve ser um único slug minúsculo de 2 a 64 caracteres.",
		"Role":                                       "Role",
		"RoleTenantIDField":                          "ID do tenant",
		"RoleKeyField":                               "Chave",
		"RoleNameField":                              "Nome",
