...
// checksum:   sha256:953d726655ffbf053ae0f2156e137fd9c4f1a1ec96e30900ddede0ee2736feb8
//
...
func TestGroupNotificationsAreTranslated(t *testing.T) {
	keys := []string{
		"InvalidGroupKeyNotification",
		"GroupKeyAlreadyExistsNotification",
		"GroupKeyIsImmutableNotification",
		"GroupTenantIsImmutableNotification",
		"GroupTenantDoesNotExistNotification",
		"RoleNotAvailableInTenantNotification",
		"GroupAlreadyGrantsRoleNotification",
		"TooManyRolesInGroupNotification",
...
func TestGroupCatalogsAnswerTheirOwnLanguage(t *testing.T) {
