...
func (nld) Translations() map[string]string {
	return map[string]string{
		...
		"RoleKeyAlreadyExistsNotification":           "Deze tenant heeft al een rol met deze sleutel.",
		"RoleKeyIsImmutableNotification":             "De rolsleutel kan niet worden gewijzigd.",
		"RoleTenantIsImmutableNotification":          "De tenant van de rol kan niet worden gewijzigd.",
		"RoleTenantDoesNotExistNotification":         "De tenant bestaat niet of is niet langer actief.",
		"PermissionNotInCatalogNotification":         "Deze permissie staat niet in de catalogus, of is niet langer actief.",
		"RoleAlreadyGrantsPermissionNotification":    "Deze rol verleent deze permissie al.",
		"TooManyPermissionsInRoleNotification":       "Een rol mag maximaal {max} permissies verlenen.",
		"CannotGrantUnheldPermissionNotification":    "U kunt geen permissie verlenen die u zelf niet heeft.",
		"CannotGrantWildcardPermissionNotification":  "Een jokerpermissie kan niet aan een rol worden verleend.",
		"InvalidRoleKeyNotification":                 "De rolsleutel moet één kleine slug van 2 tot 64 tekens zijn.",
		"Role":                                       "Role",
		"RoleTenantIDField":                          "Tenant-ID",
		"RoleKeyField":                               "Sleutel",
		"RoleNameField":                              "Naam",
		"RoleDescriptionField":                       "Beschrijving",
		"RolePermissionPermissionIDField":            "Permissie",
	}
}
