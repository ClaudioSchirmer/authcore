...
// checksum:   sha256:4cb64a51ebcf185300dad3c3fdf9954f415ff6a1e87b45abccf5ce13d8d5f878
//
...
func TestClientNotificationsAreTranslated(t *testing.T) {
	keys := []string{
		"ClientNameAlreadyExistsNotification",
		"ClientTenantIsImmutableNotification",
		"ClientTenantDoesNotExistNotification",
		"InvalidClientStatusTransitionNotification",
		"TooManyRolesForClientNotification",
		"ClientAlreadyGrantsRoleNotification",
		"TooManyAllowedCIDRsForClientNotification",
		"ClientAlreadyAllowsCIDRNotification",
		"InvalidCIDRBlockNotification",
		"CIDRHasHostBitsSetNotification",
		"UniversalCIDRNotAllowedNotification",
		...
		"ClientAlreadyHoldsClaimNotification",
		"TooManyClaimsForClientNotification",
		"ClaimNotAvailableInTenantNotification",
		"ClaimDoesNotApplyToClientNotification",
...
func TestClientCatalogsAnswerTheirOwnLanguage(t *testing.T) {
