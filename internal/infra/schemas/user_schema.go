...
//
// The users schema (11 columns).
//
// entity:     User
// spec:       specs/omnicore-gen/user.omnicore.yaml
// generator:  omnicore-gen
// generated:  2026-08-26
// checksum:   sha256:65576a21f11a7859852ea806df0ba3872692bb5476c7da6d5acac442d311843a
//
...
func UserSchema() *core.TableSchema {
	return core.NewTableSchema[*appdomain.User]("users").
		...
		Field("FailedLoginAttempts", "failed_login_attempts").
		Field("LockedUntil", "locked_until").
		Field("Status", "status").
