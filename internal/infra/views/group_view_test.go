...
// checksum:   sha256:6bd2405f91f5d95b56812df7d29e70ca2a1ad52d0b45ff5bce383896b60fac9e
//
...
func TestGroupViewBuilds(t *testing.T) {
	v := GroupView(nil)
	if v == nil {
		t.Fatal("the view definition is nil")
	}
	if got := v.Name(); got != "groups" {
		t.Errorf("the view is named %q, the spec says %q", got, "groups")
	}
}
