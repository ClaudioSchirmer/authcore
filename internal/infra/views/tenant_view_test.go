...
// checksum:   sha256:d1c648f81468763391911eeb31d877cb8bad01f771ed4aa70daf6705ad8571f6
//
...
func TestTenantViewBuilds(t *testing.T) {
	v := TenantView(nil)
	if v == nil {
		t.Fatal("the view definition is nil")
	}
	if got := v.Name(); got != "tenants" {
		t.Errorf("the view is named %q, the spec says %q", got, "tenants")
	}
}
