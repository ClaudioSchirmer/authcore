...
### `internal/infra/group_service_manual.go` — bodies the spec no longer asks for
...
- `func (s *GroupServiceImpl) companions(...)`
- `func (s *GroupServiceImpl) roleRows(...)`
...
- GroupArchivedAtField — internal/application/translations/deu.go
- GroupArchivedAtField — internal/application/translations/esp.go
- GroupArchivedAtField — internal/application/translations/fra.go
- GroupArchivedAtField — internal/application/translations/ita.go
- GroupArchivedAtField — internal/application/translations/nld.go
- GroupArchivedAtField — internal/application/translations/ptbr.go
- GroupCreatedAtField — internal/application/translations/deu.go
- GroupCreatedAtField — internal/application/translations/esp.go
- GroupCreatedAtField — internal/application/translations/fra.go
- GroupCreatedAtField — internal/application/translations/ita.go
- GroupCreatedAtField — internal/application/translations/nld.go
- GroupCreatedAtField — internal/application/translations/ptbr.go
- GroupUpdatedAtField — internal/application/translations/deu.go
- GroupUpdatedAtField — internal/application/translations/esp.go
- GroupUpdatedAtField — internal/application/translations/fra.go
- GroupUpdatedAtField — internal/application/translations/ita.go
- GroupUpdatedAtField — internal/application/translations/nld.go
- GroupUpdatedAtField — internal/application/translations/ptbr.go
