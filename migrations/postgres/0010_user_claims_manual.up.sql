...
COMMENT ON COLUMN "user_claims"."archived_at" IS 'Archive stamp; a non-null value hides the entry from reads.';
...
CREATE UNIQUE INDEX "user_claims_user_id_claim_id_key" ON "user_claims" ("user_id", "claim_id") WHERE "archived_at" IS NULL;
